...
using MTS.IR.Postgre.DAL.NotQP;
using MTS.IR.Postgre.DAL.NotQP.Models;
using MTS.IR.Services.Models;
...
namespace MTS.IR.Services
{
    public class EmailNotificationService : IEmailNotificationService
    {
        ...
        public const string checkEmailName = "MTS.IR.Services.EmailTemplates.CheckEmail.cshtml";
        public const string newsEmailName = "MTS.IR.Services.EmailTemplates.NewsEmail.cshtml";
        ...
        private async Task<string> GetConvertedLogoImage()
        {
            string base64ImageRepresentation = "";
            try
            {
                var path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resource", "mts-logo.jpg");
